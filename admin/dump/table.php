    ...
    if ($tablesNames) {
        ...
        foreach ($tablesNames as $tablesName) {
            echo '<li class="w-full h-14 flex justify-center">
               <form action="table.php?db=' . $selectedDatabase . '&table=' . $tablesName . '&Branch_Name=" method="post" class="ring-1 flex p-2 w-full justify-between">
                   <input type="hidden" name="formType" value="deleteTable">
                   <a href="tableDetails.php?db=' . $selectedDatabase . '&table=' . $tablesName . '&Branch_Name=" class="m-0 p-0  capitalize">' . $tablesName . '</a>
